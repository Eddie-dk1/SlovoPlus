...
> = {
  ru: {
    ...
    'в целях': {
      phrase: 'в целях',
      replacements: ['чтобы', 'для', 'ради'],
      note: 'Если фраза не из документа, часто достаточно простого «чтобы» или «для».',
      before: 'В целях улучшения текста мы убрали повторы.',
      after: 'Чтобы улучшить текст, мы убрали повторы.',
    },
    'по причине': {
      phrase: 'по причине',
      replacements: ['из-за', 'потому что', 'так как'],
      note: 'Выбирай короткую причинную связку, если официальный оттенок не нужен.',
      before: 'Работа задержана по причине отсутствия данных.',
      after: 'Работа задержана из-за отсутствия данных.',
    },
    канцеляризм: {
      phrase: 'канцеляризмы',
